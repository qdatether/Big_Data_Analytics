function [nrmseV,phiV,thetaV,SDz,aicS,fpeS,armamodel,xpreV]=fitARMA(xV,p,q,Tmax)
...
%               nrmseV)
%  xpreV   : the vector of estimated (one-time step ahead predicted) values. Note that 
%            the vector has size n, i.e. the estimated values are for times 1,2,...,n
